...
public class QLDSPhongChoi extends UnicastRemoteObject implements GiaoDienQLDSPhongChoi
{
    ...
    {
        //ma code duoc tao bang cach random vs dieu kien(rang buoc) ma code co 4 chu so
    ...
    public int vaoPhong(int code, String tenNguoiChoi) throws RemoteException 
    {
        ...
        if(viTriPhong != -1){
            ...
            switch (sttRanCanThem) {
                case 1:
                    //Nguoi vao phong se duoc them vao ran 01
                    arrDiem.clear();
                    ...
                    break;
                case 2:
                    //Nguoi vao phong se duoc them vao ran 02
                    arrDiem.clear();
                    ...
                    break;
                case 3:
                    //Nguoi vao phong se duoc them vao ran 03
                    arrDiem.clear();
                    ...
                    break;
                case 4:
                    //Nguoi vao phong se duoc them vao ran 04
                    arrDiem.clear();
    ...
    //dieu khien cac con ran trong luc choi
    @Override
            ...
            for(int i = 0; i < 4; i++)
            {
                if(arrayPhongChoi.get(viTriPhong).getArrayRan().get(i) != null && arrayPhongChoi.get(viTriPhong).getArrayRan().get(i).getArrayDiem() != null){
                    if(arrayPhongChoi.get(viTriPhong).getArrayRan().get(i).getiDRan() == idRan){
                        //Xac dinh huong hien tai cua ran
                        ...
                        if(mangDiem.get(0).getY() == mangDiem.get(1).getY()){//Di chuyen theo huong ngang
                            trangtraiDiChuyenNgang = true;
                            trangtraiDiChuyenDoc = false;
                        }
                        else
                        {//Di chuyen theo huong doc
                        ...
                        }else if(trangThaiDiChuyen == 2 && trangtraiDiChuyenDoc == false){//Xuong
                            mangDiemBiThayDoi.add(new Diem(mangDiem.get(0).getX(), mangDiem.get(0).getY() + 1));
                            for(int h = 1; h < mangDiem.size(); h++){
                                mangDiemBiThayDoi.add(mangDiem.get(h - 1));
                            }
                            
                        }else if(trangThaiDiChuyen == 3 && trangtraiDiChuyenNgang == false){//Trai
                            mangDiemBiThayDoi.add(new Diem(mangDiem.get(0).getX() - 1, mangDiem.get(0).getY()));
                            for(int h = 1; h < mangDiem.size(); h++){
                                mangDiemBiThayDoi.add(mangDiem.get(h - 1));
                            }

                        }else if(trangThaiDiChuyen == 4 && trangtraiDiChuyenNgang == false){//Phai
                            mangDiemBiThayDoi.add(new Diem(mangDiem.get(0).getX() + 1, mangDiem.get(0).getY()));
                           for(int h = 1; h < mangDiem.size(); h++){
                               mangDiemBiThayDoi.add(mangDiem.get(h - 1));
                           }
    ...
    //cac con ran tu dong di chuyen khi bat dau
